...
def replication_quorum_size(n):
    """
    quorum size as it applies to services that still use 'replication'
    for data integrity  (Account/Container services).  Object quorum_size
    is defined on a storage policy basis
